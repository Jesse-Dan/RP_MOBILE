...
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'assets/icons/images/ic_like_fill.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'assets/icons/images/ic_like_fill.png';
        case 2:
          return 'assets/icons/images/love2.png';
        case 3:
          return 'assets/icons/images/haha2.png';
        case 4:
          return 'assets/icons/images/wow2.png';
        case 5:
          return 'assets/icons/images/sad2.png';
        case 6:
          return 'assets/icons/images/angry2.png';
        default:
          return 'assets/icons/images/ic_like.png';
      }
    } else {
      return 'assets/icons/images/ic_like.png';
    }
  ...
  Future playSound(String nameSound) async {
    ...
    await audioPlayer.play(
      file.path as Source, /* isLocal: true*/
    );
  }
